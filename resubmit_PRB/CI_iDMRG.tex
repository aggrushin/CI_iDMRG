...
\begin{figure}
 ...
 \textcolor{blue}{Inset: Scaling of the entanglement entropy $S$ with the bond dimension $\chi$.}
 \label{fig:cut_V2_0} }
\end{figure}
%
...
\begin{figure}
 ...
 %
 \textcolor{blue}{Inset: Jump of the entanglement entropy at the Kekul\'e--SM transition.}\label{fig:cut_V1_6}}
\end{figure}
%
...
%
A first order transition is also consistent with the entanglement entropy which displays a small jump when crossing the phase boundary \textcolor{blue}{(see inset of Fig.~\ref{fig:cut_V1_6})}.
%
\begin{figure}
...
%
\textcolor{blue}{Even when initializing the iDMRG calculations with a time reversal symmetry broken Chern insulator wave function, the state did not remain stable and evolved into the respective competing phases upon performing the algorithm.}
%
