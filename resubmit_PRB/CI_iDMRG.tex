...
\begin{figure}
 ...
 %
 \textcolor{blue}{Inset: Scaling of the entanglement entropy $S$ with the bond dimension $\chi$ for two values of $V_{1}$ in the semimetal and CDW phase. 
 %
 Unlike the CDW-I, the semimetal phase presents the typical critical entanglement scaling $S\propto \log\chi$.
 }
 %
 \label{fig:cut_V2_0} }
\end{figure}
...
\begin{figure}
 ...
 %
 \textcolor{blue}{Inset:  The vicinity the Kekul\'e--SM transition showing the discontinuity of the entanglement entropy as a function of $V_{2}$ }\label{fig:cut_V1_6}}
\end{figure}
%
