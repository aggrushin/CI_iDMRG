...
%
In this work we revisit the problem using the infinite density matrix renormalization group method we report numerical evidence supporting 
%
...
\begin{figure*}
 ...
 %
 For (c) dashed lines indicate defect lines of rotated hexagons that have zero energetic cost at $t=0$ (see main text).
 %
