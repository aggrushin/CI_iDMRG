...
% 
It is interesting to point out that the CMs state is expected from a semi-classical analysis as well.
%
...
%
Within this approach, the hopping can be introduced as a perturbation $t$.
\noteAG{Maybe Fernando can rewrite this part as he likes.} 
