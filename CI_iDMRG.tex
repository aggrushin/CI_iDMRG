...
%
For instance, at $V_{1}/t = 4$ and $V_{2}/t = 0.4$ we find that $M=$. \noteAG{I mention this as an example since we don't show the order, I don't know. Number needed}
%
...
%
At high $V_{2}$ and neighbouring the charge orders CDW II and CDW I
we find a third type of charge order.
%
Similarly to the CDW II this state has a 12 site unit cell but it is unlike the former in
that it cannot be connected to a classical strong coupling state.
%
