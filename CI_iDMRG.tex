...
\begin{figure}
 ...
 %
 In this plot, several phase transitions are made visible. With increasing $V_2$, the CDW~I phase turns into the Kekul\'e phase which itself goes into the semimetal phase.
 %
 The transition from semimetal to CDW~II can clearly be identified by the peak in the correlation length. \label{fig:cut_V1_6}}
\end{figure}
%
...
%
A similiar second order transition was reported in the related antiferromagnetic Heisenberg model between a N\'eel and a plaquette phase~\cite{GvdBN13,ASHCML11,CL15}.
%
This transition was conjectured to show deconfined quantum critical behavior~\cite{SVBSF04,Yao}.
%
% However, a second order transition would be in disagreement with a Landau theory point of view from which we would expect a first order transition between the CDW~I and Kekul\'e phases since they break different symmetries.
% %
% Yet, in the related antiferromagnetic Heisenberg model with competing $J_1-J_2$-interactions, a second order transition between the N\'eel state --corresponding to CDW~I in our model-- and a plaquette phase --related to the Kekul\'e phase-- has been reported~\cite{GvdBN13,ASHCML11}.
% %
% This transition goes beyond the Landau paradigm and was proposed to show deconfined quantum criticality~\cite{GvdBN13,SVBSF04}.
% %
% It is possible that the spinless fermion model shows a smiliar fermionic version of this kind of critical behavior at the discussed phase boundary.
%

Surprisingly for a gapped phase, the correlation length scales with $\chi$ even in the center of the the Kekul\'e region.
%
...
%
The diverging correlation length on the CDW~II side of the transition points toward a second order phase transition.
%
...
%
On the other hand, we can also see a finite jump of the correlation length between semimetal and CDW~II phase which would indicate a first order transition.
%
Since the state in the semimetal phase cannot be represented faithfully with an MPS of finite bond dimension, it is difficult to evaluate the exact behavior at this transition and a definite statement goes beyond the limitations of iDMRG for gapless states.
%
\begin{figure}
