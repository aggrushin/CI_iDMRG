...
%
For instance, at $V_{1}/t = 4$ and $V_{2}/t = 0.4$ we find that $M=0.817$.
%
...
%
A sample of the six site unit cell charge and bond pattern obtained from \eqref{eq:charge} for $V_1/t = 0.8, V_2/t = 3.2 $ is shown in Fig.~\ref{fig:phase diagram}(a) with charge values given by $\varrho=0.364$ and $\Delta = 0.092$ (see Fig.~\ref{fig:orders}(c)).
%
...
\begin{figure}
 ...
 \caption{Correlation length at $V_2=0$, labeled cut A in Fig.~\ref{fig:phase diagram}. The dashed grey line at $V_1/t = 1.356$ shows where the transition has been detected in quantum Monte Carlo \cite{WCT14}. \label{fig:cut_V2_0} }
\end{figure}
% 
%
...
\begin{figure}
 ...
 \caption{Entanglement entropy at $V_2/t=3.6$, labeled cut B in Fig.~\ref{fig:phase diagram}. \label{fig:cut_V2_3.6}}
\end{figure}
% 
...
\begin{figure}
 ...
 \caption{Entanglement entropy at $V_1/t=0.4$, labeled cut C in Fig.~\ref{fig:phase diagram}. \label{fig:cut_V1_0.4}}
\end{figure}
%
...
\begin{figure}
 ...
 \caption{Correlation length at $V_1/t=6$, labeled cut D in Fig.~\ref{fig:phase diagram}. \label{fig:cut_V1_6}}
\end{figure}
%
...
The last phase boundary in this cut lies between the CDW III and CDW II phases.
%
...
%
So, we conclude that the this tranisition is of first order.
