...
including two novel charge order phases (CDW-I and CDW-II) together with the previously 
reported Kekul\'{e}, CMs, CDW and semimetal phases.
%
...
%
We show a representative of the state's charge and bond order patterns in Fig.~\cite{}(e) and (d) 
...
and no charge order.
%
Compared to mean field, this state occurs
