...
%
We have used this method to diagonalize two clusters: a 12 site cluster, 
%with the shape of the unit cell of the CDW II phase (12 sites, as shown in Fig.~\ref{fig:phase diagram}(c)), 
%
...
shown schematically in Fig.~\ref{fig:phase diagram}(c) while the other six correspond to those states with defect lines determined by rotated hexagons, 
as described in sec.~\ref{sec:phasediagram} E. 
%
