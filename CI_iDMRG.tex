...
\begin{figure}
 ...
 %
 The transition from semimetal to CDW~II presents a diverging 
 correlation length as the bond dimension is increased signaling a second order phase transition. \label{fig:cut_V1_6}}
\end{figure}
%
...
%
A similiar second order transition was reported in the related antiferromagnetic Heisenberg model with competing $J_1-J_2$-interactions between a N\'eel and a plaquette phase~\cite{GvdBN13,ASHCML11,CL15}.
%
The latter was conjectured to show deconfined quantum critical behavior~\cite{SVBSF04,Yao}.
%
