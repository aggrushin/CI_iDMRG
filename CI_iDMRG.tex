...
%
This leads to the second way to describe this phase which makes use of the mentioned criticality.
%
...
%
For a system with two Dirac cones, $c=2$ which is 
%
\noteAG{This last paragraph can be removed if we don't need it}

A second way the entanglement spectrum of the semimetal phase with the ana
...
%
Classically, for large $V_{1}\gg t$ the energy is minimised by an unequal occupation of the two sub lattices.
%
