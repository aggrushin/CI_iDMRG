...
\begin{figure}
 ...
 %
 \textcolor{blue}{With increasing $V_2$, the CDW~I phase turns into the Kekul\'e phase which itself goes into the semimetal phase.
 %
...
%
\textcolor{blue}{A similar second order transition was reported in the related antiferromagnetic Heisenberg model between a N\'eel and a plaquette phase~\cite{GvdBN13,ASHCML11,CL15}.
%
...
\textcolor{blue}{Finally, at $V_2/t \approx 2.4$ the semimetal turns into the CDW~II.
%
...
%
\textcolor{blue}{However, conclusions about the order of phase transitions from and to the semimetal phase should be taken with care due to the gapless nature of the semimetal ground state.} \\
%
